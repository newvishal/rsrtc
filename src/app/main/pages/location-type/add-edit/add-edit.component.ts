...
export class AddEditComponent implements OnInit {
  ...
  addLocationType() {
    ...
    if (this.LocationTypeForm.invalid) {
      ...
      if(this.bsubject.locationTypeId) {
        this.locationTypeService.put({...this.LocationTypeForm.value, locationTypeId: this.bsubject.locationTypeId} as ILocationType, this.bsubject.locationTypeId).subscribe({
          next: res =>{
